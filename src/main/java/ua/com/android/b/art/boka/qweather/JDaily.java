...
public final class JDaily {
    ...
    public JDaily(String cod, double message, long cnt, List[] list, City city){
        this.cod = cod;
    ...
    public static final class List {
        ...
        public static final class Main {
            ...
            public final double temp_kf;

            public Main(double temp, double temp_min, double temp_max, double pressure, double sea_level, double grnd_level, long humidity, double temp_kf){
                this.temp = temp;
...
//            public final double 3h;
//
//            public Rain(double 3h){
//                this.3h = 3h;
//            }
        }
    }
